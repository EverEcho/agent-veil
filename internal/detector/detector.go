...
func NewDefault() *Scanner {
	scanner := &Scanner{rules: []rule{
		...
		{"secret.huggingface_token", "secret.huggingface_token", domain.SeverityCritical, domain.ActionRedact, regexp.MustCompile(`\bhf_(?:oauth_)?[A-Za-z0-9]{20,}\b`), nil, 0},
		{"secret.groq_key", "secret.groq_key", domain.SeverityCritical, domain.ActionRedact, regexp.MustCompile(`\bgsk_[A-Za-z0-9]{20,}\b`), nil, 0},
		...
		{"secret.alibaba_access_key", "secret.alibaba_access_key", domain.SeverityCritical, domain.ActionRedact, regexp.MustCompile(`\bLTAI[A-Za-z0-9]{16,30}\b`), nil, 0},
		{"secret.tencent_secret_id", "secret.tencent_secret_id", domain.SeverityCritical, domain.ActionRedact, regexp.MustCompile(`\bAKID[A-Za-z0-9]{16,64}\b`), nil, 0},
		{"secret.volcengine_access_key", "secret.volcengine_access_key", domain.SeverityCritical, domain.ActionRedact, regexp.MustCompile(`(?:^|[^A-Za-z0-9_-])(AKLT[A-Za-z0-9_-]{16,124})(?:$|[^A-Za-z0-9_-])`), nil, 1},
	...
	scanner.requiredFeatures = map[string]featureSet{
		...
		"secret.huggingface_token": featureUnderscore,
		"secret.groq_key":          featureUnderscore,
	...
	prefixes := map[string][]string{
		...
		"secret.huggingface_token":     {"hf_"},
		"secret.groq_key":              {"gsk_"},
		"secret.aws_access_key":        {"AKIA", "ASIA"},
		"secret.alibaba_access_key":    {"LTAI"},
		"secret.tencent_secret_id":     {"AKID"},
		"secret.volcengine_access_key": {"AKLT"},
