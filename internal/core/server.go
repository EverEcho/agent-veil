...
:root{color-scheme:dark;font-family:ui-sans-serif,system-ui;background:#0b0e14;color:#e8edf5}body{max-width:1100px;margin:0 auto;padding:40px 24px}h1{letter-spacing:-.04em}.muted{color:#8c98aa}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px}.card{background:#141925;border:1px solid #273044;border-radius:14px;padding:18px}.route{padding:10px 0;border-top:1px solid #273044}.call{margin:8px 0}.depth-0{margin-left:0}.depth-1{margin-left:24px}.depth-2{margin-left:48px}.depth-3{margin-left:72px}.depth-4{margin-left:96px}.depth-5{margin-left:120px}.depth-6{margin-left:144px}.depth-7{margin-left:168px}.depth-8{margin-left:192px}.status{font-weight:700;text-transform:uppercase}.active,.protected,.local{color:#55d89b}.blocked,.unprotected,.error{color:#ff6b76}.partial,.observed{color:#f2bd5a}button,input,textarea{background:#1e2635;color:inherit;border:1px solid #35415a;border-radius:8px;padding:10px}button{cursor:pointer}textarea{box-sizing:border-box;width:100%;min-height:150px;font:13px ui-monospace,monospace;resize:vertical}.controls{display:flex;gap:10px;align-items:center;margin-top:10px}</style></head><body>
