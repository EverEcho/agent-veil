...
var records = []Record{
	...
	{Agent: "hermes", Version: "0.20.6", Platform: "linux", Mode: domain.ModeLaunch, Surface: domain.SurfaceUnknown, Protocol: domain.ProtocolUnknown, Auth: domain.AuthPassthrough, Coverage: domain.CoverageProtected, Verification: VerificationLaunchSmoke, Notes: "same-runtime openai-codex routes: 17-surface planning, isolated config parsing, runtime resolver routing, and protected launch verified"},
