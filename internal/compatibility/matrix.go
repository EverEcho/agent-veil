...
var records = []Record{
	...
	{Agent: "hermes", Version: "0.20.6", Platform: "linux", Mode: domain.ModeLaunch, Surface: domain.SurfaceUnknown, Protocol: domain.ProtocolUnknown, Coverage: domain.CoverageProtected, Verification: VerificationLaunchSmoke, Notes: "17-surface route planning, isolated config parsing, and protected --help launch verified"},
