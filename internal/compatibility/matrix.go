...
var records = []Record{
	...
	{Agent: "hermes", Version: "0.20.6", Platform: "linux", Mode: domain.ModeLaunch, Surface: domain.SurfaceUnknown, Protocol: domain.ProtocolUnknown, Coverage: domain.CoverageUnprotected, Verification: VerificationDiscoveryOnly, Notes: "versioned model and MCP surface discovery verified; protected launch rewriting is not implemented"},
